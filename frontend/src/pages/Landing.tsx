      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-20">
          <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white hover:bg-white/15 transition-all">
            <CardHeader>
              <div className="w-12 h-12 bg-[var(--accent-500)] rounded-lg flex items-center justify-center mb-4">
        ...
        {/* Stats Section */}
        <div className="grid md:grid-cols-3 gap-8 mt-20 text-center text-white">
          <div className="p-8">
